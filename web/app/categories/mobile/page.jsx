...
export default function MobilePage() {
  ...
  useEffect(() => {
    const fetchMobile = async () => {
      try {
        const res = await fetch("/api/product/category/Mobile");
  ...
  const filteredProducts = mobileProducts.filter((p) =>
  ...
  const categories = [
    { name: "All Smartphones", count: mobileProducts.length },
    ...Array.from(
      mobileProducts.reduce((map, product) => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Smartphones & Tablet</h1>
          <p className="text-gray-600">
            Discover the latest Smartphones & Tablets
          </p>
        </div>
